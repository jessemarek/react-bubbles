...
- [ ] Explain what a token is used for.
    ...
    *A token is used as a layer of security or user flow on a site via private or protected routes. It can also be used to reject requests made to a server for data without a token. Users will only be able to access certain areas of the app if they have sent a request to the server and received a token back. Usually this is achieved by loggin in with a username and password.*

- [ ] What steps can you take in your web apps to keep your data secure?

    *By using tokens and protected or private routes*

- [ ] Describe how web servers work.

    *Web servers hold the code for the app and send that code to a user when the server receives requests from the users computer*
